public class MetroCardTester
{
    ...
    System.out.println(card5.swipe());          // false
        ...
        System.out.println("New UnlimitedMetroCard (with infinite swipes):");
        UnlimitedMetroCard card6 = new UnlimitedMetroCard(33);
        System.out.println(card6.swipe());          // true
        System.out.println(card6.swipe());          // true
        System.out.println(card6.swipe());          // true
        System.out.println(card6.swipe());          // true
        System.out.println("It's been 6 days...");
        card6.newDay();
        card6.newDay();
        card6.newDay();
        card6.newDay();
        ...
        System.out.println(card6.swipe());          // true
        System.out.println(card6.swipe());          // true
        System.out.println("2 days pass");
        card6.newDay();
        card6.newDay();
